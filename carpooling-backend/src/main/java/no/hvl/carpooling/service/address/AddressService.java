package no.hvl.carpooling.service.address;
...
import no.hvl.carpooling.database.repository.AddressRepository;
...
public class AddressService {
    ...
    public List<GeonorgeAddress> search(String query) {
    ...
    public Address saveAddress(GeonorgeAddress addressDto) {
